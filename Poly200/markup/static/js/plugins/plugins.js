...
var ZorbixAjaxPortfolio = function(container, options) {
    ...
    var closeButton = function() {
        ...
        this.projectWrapper.find('.close-btn').click(function() {
            ...
            $('.port-item').removeClass('port-item--active');
            return false;
        });
    }; // End closeButton
    ...
    var setSlidler = function() {
        $(slider_name).bxSlider({
            ...
            onSliderLoad: function(){
                $('.portfolio-slider__caption').html($('.bxslider li').eq(1).find('img').attr('title'));
                if($('.bxslider li').eq(1).find('img').data('copy')) {
                    $('.portfolio-slider__copyright').addClass('copy-sign').html($('.bxslider li').eq(1).find('img').data('copy'));
                }
                else {
                    $('.portfolio-slider__copyright').text('');
                }
                $('.portfolio-slider__copyright').html($('.bxslider li').eq(1).find('img').data('copy'));
            },
            onSlideBefore: function($slideElement, oldIndex, newIndex){
                $('.portfolio-slider__caption').html($slideElement.find('img').attr('title'));
                if($slideElement.find('img').data('copy')) {
                    $('.portfolio-slider__copyright').addClass('copy-sign').html($slideElement.find('img').data('copy'));
                }
                else {
                    $('.portfolio-slider__copyright').removeClass('copy-sign').text('');
                }
            }
        });
