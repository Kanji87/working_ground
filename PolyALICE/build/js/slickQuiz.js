...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'ответить',
                nextQuestionText: 'дальше',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                //questionCountText: 'Вопрос %current из %total',
                questionCountText: 'Вопрос # %current',
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<h3 class="test-heading">' + formatQuestion + '</h3>');
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var optionLabel = '<label onclick="" for="' + optionId + '">' + answer.option + '</label>';
