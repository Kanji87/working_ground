    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                preventUnansweredText: 'Вы должны выбрать ответ',
                questionTemplateText:  '%count. %text',
                scoreTemplateText: '%score из %total',
                nameTemplateText:  '<span>Тест: </span>%name',
        ...
        plugin.method = {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<div class="button-wrapper"><a href="#" class="button ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a></div>');
                        } else {
                            questionHTML.append('<div class="button-wrapper"><a href="#" class="button ' + nextQuestionClass + '">' + nextText + '</a></div>');
                            questionHTML.append('<div class="button-wrapper"><a href="#" class="button ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a></div>');
                        }
            ...
            completeQuiz: function(options) {
                ...
                var reuslt;
                if(score >= 0 && score <= 4) {
                    result = "Я прошел тест «Уорхол или Роршах» на сайте Политеха с результатом " + score + ". Я вообще не в курсе, кто эти люди и почему эти непроизносимые фамилии стоят рядом в одной фразе.";
                    ...
                    result = "Я прошел тест «Уорхол или Роршах» на сайте Политеха с результатом " + score + ". Я в равной степени презираю поп-арт и психодиагностику. Да и онлайн-тесты тоже.";
                    $(".social-likes").data("title", result);
                    score = score + ' пятен';
                }
                else if(score >= 8 && score <= 10) {
                    result = "Я прошел тест «Уорхол или Роршах» на сайте Политеха с результатом " + score + ". Я знаю все на свете и не стесняюсь похвастаться этим в соцсетях — больше меня нигде не слушают.";
                    $(".social-likes").data("title", result);
                    score = score + ' пятен';
                }
                ...
                if (plugin.config.disableScore) {
                    ...
                    $(_quizScore + ' span').html(plugin.config.scoreTemplateText
                        .replace('%score', displayScore).replace('%total', questionCount + '-ти'));
                }
